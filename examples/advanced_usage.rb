...
auth_request[11] = rand(100000..999999).to_s.rjust(6, '0')
...
auth_response[38] = rand(100000..999999).to_s  # 6-digit auth code
...
original[11] = "123456"
original[37] = "#{Time.now.to_i % 100000000}".rjust(12, '0')  # 12-digit RRN
